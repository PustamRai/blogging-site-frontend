      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="text-center">
          ...
          <p className="text-lg text-orange-700 mb-8 max-w-2xl mx-auto text-pretty">
            Discover expert tips, tutorials, and guides on web development,
            productivity, and tech trends to help you level up your skills.
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg border border-orange-100 p-6">
            ...
            <p className="text-orange-700 text-sm">
              Trusted pet care tips from professionals
            </p>
          </div>
          <div className="bg-white rounded-lg border border-orange-100 p-6">
            <h3 className="text-lg font-semibold text-orange-900 mb-2">
            ...
            <p className="text-orange-700 text-sm">
              Step-by-step instructions for pet training
            </p>
          </div>
          <div className="bg-white rounded-lg border border-orange-100 p-6">
            <h3 className="text-lg font-semibold text-orange-900 mb-2">
